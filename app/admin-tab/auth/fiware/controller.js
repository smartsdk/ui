...
export default Ember.Controller.extend({
  ...
  numUsers: function() {
    return this.get('model.allowedIdentities').filterBy('externalIdType',C.PROJECT.TYPE_FIWARE_USER).get('length');
  }.property('model.allowedIdentities.@each.externalIdType','wasRestricted'),

  numOrgs: function() {
    return this.get('model.allowedIdentities').filterBy('externalIdType',C.PROJECT.TYPE_FIWARE_ORG).get('length');
  }.property('model.allowedIdentities.@each.externalIdType','wasRestricted'),
